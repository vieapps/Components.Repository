		...
		public static void Initialize(Func<IEnumerable<Assembly>> selector = null, Action<string, Exception> tracker = null)
			=> RepositoryStarter.Initialize(selector != null
				...
				: new[] { Assembly.GetCallingAssembly() }.Concat(Assembly.GetCallingAssembly()
					...
					.Where(an => !an.Name.IsStartsWith("clr") && !an.Name.IsStartsWith("mscor") && !an.Name.IsStartsWith("sos") && !an.Name.IsStartsWith("lib")
						...
						&& !an.Name.IsStartsWith("Serilog") && !an.Name.IsStartsWith("MsgPack") && !an.Name.IsStartsWith("ExcelData") && !an.Name.IsStartsWith("SixLabors")
